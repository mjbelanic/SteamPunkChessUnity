...
public class BishopLogic : MonoBehaviour
{
    private int startX;
    private int startY;
    private int moveCheckCounter;
    internal Dictionary<string, int[]> GetBishopMovementSpaces(Piece piece, int x, int y, Piece[,] p, bool canContinue, int moveCheckCounter = 0)
    {
